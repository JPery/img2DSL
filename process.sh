...
mkdir default_punct
combine_tessdata -u /usr/local/share/tessdata/eng.traineddata default_punct/default_punct. 1>/dev/null 2>/dev/null
...
cd default_punct
combine_tessdata default_punct. 1>/dev/null 2>/dev/null
...
combine_tessdata -u /usr/local/share/tessdata/eng.traineddata default_punct_lang/default_punct_lang. 1>/dev/null 2>/dev/null
wordlist2dawg wordlistfile default_punct_lang.lstm-word-dawg default_punct_lang/default_punct_lang.lstm-unicharset 1>/dev/null 2>/dev/null
...
combine_tessdata default_punct_lang. 1>/dev/null 2>/dev/null
